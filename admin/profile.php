                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                    <div class="full dis_flex center_text">
                                       <div class="profile_img"><img width="180" class="rounded-circle" src="<?php echo "uploads/" . $data['image']; ?>" alt="#" /></div>
                                       <div class="profile_contant">
                                          <div class="contact_inner">
                                             <h3><?php echo htmlspecialchars($data['name']); ?></h3>
                                             <p><strong>About: </strong> <?php echo htmlspecialchars($data['about']); ?></p>
                                             <ul class="list-unstyled">
                                                <li><i class="fa fa-envelope-o"></i> : <?php echo htmlspecialchars($data['email']); ?></li>
                                                <li><i class="fa fa-phone"></i> : <?php echo htmlspecialchars($data['phone']); ?></li>
                                             </ul>
                                          </div>
