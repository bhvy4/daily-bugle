    ...
    if (isset($_POST['submit'])) {
        ...
        if (!array_filter($errors)) {
            if (move_uploaded_file($_FILES["images"]["tmp_name"], $target_dir . $image)) {
                echo $cat, $subcategory, $image, $created_on, $created_on;
                $sql2 = "insert into subcategory(category_id,name,image,created_on,updated_on) values('$cat','$subcategory','$image','$created_on','$created_on')";
                                ...
                                <div class="login-section">
                                    <div class="login_form">
                                        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
                                            <fieldset>
                                                <div class="field">
                                                    <label for="cat" class="label_field">Category:</label>
                                                    <select name="cat" id="cat" placeholder='select' required>
